  ...
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'max-h-[90vh] overflow-y-auto rounded-[var(--radius-card)] border border-border bg-white p-6',
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 text-ink-400 hover:text-ink-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 rounded-sm">
        <X className="size-4" />
